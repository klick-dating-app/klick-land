...
const testimonials = [
    {
        id: 1,
        videoUrl: "https://firebasestorage.googleapis.com/v0/b/klick-platform-1.firebasestorage.app/o/chatbot_media%2FVisa_Aprobada_Video_Generado.mp4?alt=media&token=5506d972-daaf-4514-8079-2b357abbddec",
        name: "@klick",
        description: "Nuestros vips logrando sus metas."
    },
    {
        id: 2,
        videoUrl: "https://firebasestorage.googleapis.com/v0/b/klick-platform-1.firebasestorage.app/o/chatbot_media%2FVisa_Aprobada_Video_Generado.mp4?alt=media&token=5506d972-daaf-4514-8079-2b357abbddec",
                ...
                <div className="mb-12 flex flex-col md:flex-row justify-between items-end gap-6">
                    <div className="max-w-4xl">
                        ...
                        <p className="text-xl text-gray-500 font-medium leading-relaxed">
                            Descubre por qué cientos de vips confían en nosotros para su futuro.
                        </p>
                    </div>
