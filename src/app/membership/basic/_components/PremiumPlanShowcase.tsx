...
const features = [
    {
        ...
        icon: Plane,
        image: "/assets/generated/membership_premium_showcase.png"
    },
    {
        id: "hospedaje",
                    ...
                    <div className="w-full lg:w-1/3 flex flex-col relative z-10">
                        ...
                        <div className="mb-8">
                            ...
                            <div className="mt-4 space-y-2 max-w-sm">
                                ...
                                <p className="text-xs text-slate-400 font-normal leading-relaxed">
                                    ¿Por qué estresarte planeando? Nosotros nos encargamos de todo: desde la membresía hasta el último detalle de tu aventura familiar.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mt-6 lg:mt-auto flex flex-col sm:flex-row gap-4 self-start w-full sm:w-auto">
                            <Button
                                ...
                                onClick={() => router.push('/instructions-payment-basic?plan=premium')}
                            >
                                Elegir Plan Premium
                            </Button>
                            <Button
