...
const studentVideos = [
    ...
    { id: 5, videoId: baseVideos[0], handle: "@klick", title: "Explorando nuevas ciudades 🌆" },
    { id: 6, videoId: baseVideos[1], handle: "@klick", title: "Comunidad Klick 🤝" },
    { id: 7, videoId: baseVideos[2], handle: "@klick", title: "Historias que inspiran 🚀" }
];
